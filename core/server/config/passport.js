...
//        return db.User.find({ where: { $or : [{ email: email },{ username: email }] }}).then(function(user) {
//            if (!user) {
//
...
//
//        return  db.User.find({where: {twitterUserId: profile.id}}).then(function(user){
//            if(!user){
//                db.User.create({
...
//
//        return db.User.find({where : {facebookUserId: profile.id}}).then(function(user){
//            if(!user){
//                db.User.create({
//                    name: profile.displayName,
